...
<table class="body-wrap">
    <tr>
        <td class="container" bgcolor="#FFFFF2">
            <div class="content">
                <p>Hi {{ $user['name'] }},</p>
                <p>You're requesting a temporary password for your account, please click the link below:</p>
                <p><a href="http://{{$config['app_url']}}/requestPassword/{{$user['email']}}/{{ $user['remember_token'] }}">http://ems.lay-bare.com/requestPassword/{{$user['email']}}/{{ $user['remember_token'] }}</a></p>
                <br/>
                <p>Thank you!</p>
            </div><!-- /content -->
        </td>
