...
<table class="body-wrap">
    <tr>
        <td class="container" bgcolor="#FFFFF2">
            <div class="content">
                <p>Hi {{ $user['name'] }},</p>
                <p>You missed having an attendance on date: {{ json_decode($notification['notification_data'])->date }}</p>
                <p>If you're present on that day please file a corresponding employee form.</p>
                <br/>
                <br/>
                <p>Thank you!</p>
            </div><!-- /content -->
